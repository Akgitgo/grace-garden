    ...
    return (
        <div className="fixed bottom-16 right-6 z-50 flex flex-col gap-4 items-end">
            ...
            <motion.a
                ...
                whileTap={{ scale: 0.9 }}
                className="w-14 h-14 bg-[#25D366] rounded-full shadow-lg flex items-center justify-center text-white hover:bg-[#20bd5a] transition-colors relative group"
                aria-label="Chat on WhatsApp"
            >
                <svg viewBox="0 0 24 24" width="28" height="28" fill="white" className="text-white">
